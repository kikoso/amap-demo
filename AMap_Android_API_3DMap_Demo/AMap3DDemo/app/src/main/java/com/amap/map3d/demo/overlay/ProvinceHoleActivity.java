...
public class ProvinceHoleActivity extends Activity implements DistrictSearch.OnDistrictSearchListener {
    ...
    private void setUpMap() {
        ...
        polygon = aMap.addPolygon(new PolygonOptions().addAll(latLngs).fillColor(Color.argb(255,245,245,245)).zIndex(10));
            ...
            ThreadUtil.getInstance().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    if(holeOptionsList.size() > 0) {
                        ...
                        for(com.amap.api.maps.model.BaseHoleOptions holeOptions : holeOptionsList) {
                            com.amap.api.maps.model.PolygonHoleOptions polygonHoleOption = (com.amap.api.maps.model.PolygonHoleOptions)holeOptions;
                            android.util.Log.e("amap","polygonHoleOption size " + polygonHoleOption.getPoints().size());
                        }
    ...
    static class ListComparator implements Comparator<Object>,
        ...
        public int compare(Object lhs, Object rhs) {
            com.amap.api.maps.model.PolygonHoleOptions fir = (com.amap.api.maps.model.PolygonHoleOptions) lhs;
            com.amap.api.maps.model.PolygonHoleOptions sec = (com.amap.api.maps.model.PolygonHoleOptions) rhs;
            try {
